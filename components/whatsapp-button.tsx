...
function buildProductWhatsAppUrl(
  ...
  let message = `Hello ${shopName || 'LEELA JEWELLERS'}, I am interested in this product:\n\n`

  message += `Product: ${name}\n`

  if (weight) {
    message += `Weight: ${weight} GM\n`
  }
